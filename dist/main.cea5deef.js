...
var premiumPrice = document.querySelector(".premium .price");
...
elements.forEach(function (element) {
  return element.addEventListener("mouseover", toggleActive);
});
periods.forEach(function (period) {
  return period.addEventListener("change", function () {
    return premiumPrice.textContent = "".concat(period.value);
  });
});
